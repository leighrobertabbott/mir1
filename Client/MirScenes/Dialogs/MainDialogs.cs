...
namespace Client.MirScenes.Dialogs
{
    ...
    public sealed class MainCharacterDialog : MirImageControl
    {
        ...
        public MirLabel LevelLabel, ExperienceLabel, GoldLabel, WeightLabel, AccuracyLabel, DestructiveLabel, MCLabel, ACLabel, MACLabel, HPLabel, MPLabel, AgilityLabel;
