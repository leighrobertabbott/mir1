...
namespace ServerPackets
{
    ...
    public sealed class InspectPlayerResponse : Packet
    {
        public override short Index
        {
            get { return (short)ServerPacketIds.InspectPlayerResponse; }
        }
        ...
        public MirGender Gender;
        public byte Hair;
        public UserItem[] Equipment = new UserItem[8];
        public Stats Stats;
        ...
        protected override void WritePacket(BinaryWriter writer)
        {
            ...
            writer.Write(Equipment != null ? Equipment.Length : 0);
            if (Equipment != null)
            {
                for (int i = 0; i < Equipment.Length; i++)
                {
