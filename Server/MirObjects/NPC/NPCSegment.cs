            ...
            for (int i = 0; i < CheckList.Count; i++)
            {
                ...
                switch (check.Type)
                {
                    ...
                    case CheckType.CheckClass:
                        ...
                        // Attribute System - Check class role based on attributes
                        // For backward compatibility, check both actual class and attribute-determined role
                        MirClass attributeRole = Shared.Data.AttributeStatCalculator.DetermineClassRole(player.AttributeValues);
                        failed = (player.Class != mirClass) && (attributeRole != mirClass);
                        break;
