...
namespace Server.MirObjects
{
    public sealed class NPCObject : MapObject
    {
        ...
        public NPCObject(NPCInfo info)
        {
            ...
            Direction = (MirDirection)(3 + Envir.Random.Next(3));
        ...
        public override void Process()
        {
            ...
            if (Envir.Time > TurnTime)
            {
                ...
                Turn((MirDirection)(3 + Envir.Random.Next(3)));
            }
        ...
        public void CheckVisible(PlayerObject Player, bool Force = false)
        {
            ...
            // Good/Evil System - Check NPC requirements
            if (Info.RequiredGoodLevel > 0 && Player.Info.GoodLevel < Info.RequiredGoodLevel)
            {
                Player.ReceiveChat($"You need Good level {Info.RequiredGoodLevel} to interact with this NPC.", ChatType.System);
                return false;
            }

            if (Info.RequiredEvilLevel > 0 && Player.Info.EvilLevel < Info.RequiredEvilLevel)
            {
                Player.ReceiveChat($"You need Evil level {Info.RequiredEvilLevel} to interact with this NPC.", ChatType.System);
                return false;
            }
