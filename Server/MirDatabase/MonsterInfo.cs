...
namespace Server.MirDatabase
{
    public class MonsterInfo
    {
        ...
        // Good/Evil System - Monster Alignment
        public bool IsGood = false; // true = Good monster, false = Evil monster
        public bool IsNeutral = true; // true = Neutral (gives both), false = Aligned
        ...
        public MonsterInfo(BinaryReader reader)
        {
            ...
            // Good/Evil System - Load monster alignment
            if (Envir.LoadVersion > 110)
            {
                IsGood = reader.ReadBoolean();
        ...
        public void Save(BinaryWriter writer)
        {
            ...
            // Good/Evil System - Save monster alignment
            writer.Write(IsGood);
